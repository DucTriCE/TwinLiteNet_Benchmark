...
class MyDataset(torch.utils.data.Dataset):
    ...
    '''
    def __init__(self, degrees, translate, scale, shear, hgain, sgain, vgain, valid=False, transform = None):
        '''
        ...
        self.Random_Crop = A.RandomCrop(width=960, height=540)

        # self.mean,self.std=[73.93312826, 74.61554311, 71.0616474 ], [51.17922132, 50.49270223, 50.3119135 ]
